(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('dotenv/config'), require('tty'), require('util'), require('supports-color'), require('crypto'), require('fs'), require('path'), require('events'), require('buffer'), require('querystring'), require('stream'), require('os'), require('http'), require('https'), require('url'), require('zlib')) :
  typeof define === 'function' && define.amd ? define(['exports', 'dotenv/config', 'tty', 'util', 'supports-color', 'crypto', 'fs', 'path', 'events', 'buffer', 'querystring', 'stream', 'os', 'http', 'https', 'url', 'zlib'], factory) :
  (global = global || self, factory(global.Example = {}, null, global.tty, global.util, global.supportsColor, global.crypto, global.fs, global.path, global.events$1, global.buffer, global.querystring, global.stream, global.os, global.http, global.https, global.url, global.zlib));
}(this, (function (exports, config$1, tty, util, supportsColor, crypto, fs, path, events$1, buffer, querystring, stream, os, http, https, url, zlib) { 'use strict';
